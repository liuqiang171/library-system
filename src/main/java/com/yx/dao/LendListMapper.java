...
public interface LendListMapper {
    ...
    List<LendList> queryLendListByReaderId(@Param("rid") Integer rid, @Param("bookName") String bookName, @Param("status") String status);

    LendList queryLendListById(@Param("id") Integer id);
