...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label required">借阅天数</label>
        <div class="layui-input-block">
            <input type="text" name="lendDays" lay-verify="required" lay-reqtext="借阅天数不能为空" placeholder="请输入借阅天数" value="" class="layui-input">
        </div>
    </div>
...
<script>
    layui.use(['form', 'table'], function(){
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            var lendDays=datas.lendDays;
            var  value={readerNumber:readerNumber,ids:ids,lendDays: lendDays};
            lendBook(value);
        });
