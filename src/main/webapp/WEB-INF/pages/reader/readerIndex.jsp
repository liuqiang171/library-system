...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                {fixed: 'left', type: "checkbox", minWidth: 50},
                //{field: 'id', width: 100, title: 'ID', sort: true},
                {field: 'readerNumber', minWidth: 150, title: '读者卡号', align: "center"},
                ...
                {field: 'tel', minWidth: 150, title: '电话', align: "center"},
                {field: 'registerDate', templet:"<div>{{layui.util.toDateString(d.registerDate,'yyyy-MM-dd HH:mm:ss')}}</div>", minWidth: 200, title: '办卡时间', align: "center"},
                {field: 'email', templet: '<div>{{d.email}}</div>', minWidth: 150, title: '邮箱', align: "center"},
